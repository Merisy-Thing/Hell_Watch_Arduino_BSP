...
#define BAT_PIN A6
#define NUM_LVL 4
#define BAT_LVL_CRITIC  3200
#define BAT_LVL_LOW		3250
#define BAT_LVL_MED		3600
#define BAT_LVL_FULL	4000
...
#define BTN_C           6
//buttons pins
#define BTN_UP_PIN      4	//PB3
#define BTN_RIGHT_PIN   0 //PE0
#define BTN_DOWN_PIN    1 //PE1
#define BTN_LEFT_PIN    2 //PE2
#define BTN_A_PIN       6 //PB1
#define BTN_B_PIN       7 //PB0
#define BTN_C_PIN       5 //PB2

#ifdef HELL_WATCH
#define LOOP	(!(PORTA.IN & (1 << 7)))
#else
#define LOOP	1
#endif
#endif /* SETTINGS_C */
