...
void Rtc_Pcf8563::initClock()
{
  ...
  Wire.write((uint8_t)0x0);    	// start address
  	
  Wire.write((uint8_t)0x0); 	//control/status1
  Wire.write((uint8_t)0x0); 	//control/status2
  Wire.write((uint8_t)0x01); 	//set seconds
  Wire.write((uint8_t)0x01);	//set minutes
  Wire.write((uint8_t)0x01);	//set hour
  Wire.write((uint8_t)0x01);	//set day
  Wire.write((uint8_t)0x01);	//set weekday
  Wire.write((uint8_t)0x01); 	//set month, century to 1
  Wire.write((uint8_t)0x01);	//set year to 99
  Wire.write((uint8_t)0x80);	//minute alarm value reset to 00
  Wire.write((uint8_t)0x80);	//hour alarm value reset to 00
  Wire.write((uint8_t)0x80);	//day alarm value reset to 00
  Wire.write((uint8_t)0x80);	//weekday alarm value reset to 00
  Wire.write((uint8_t)0x0); 	//set SQW, see: setSquareWave
  Wire.write((uint8_t)0x0); 	//timer off
...
{
  Wire.beginTransmission(Rtcc_Addr);	// Issue I2C start signal
  Wire.write(RTCC_SEC_ADDR);   	// write addr low byte, req'd
