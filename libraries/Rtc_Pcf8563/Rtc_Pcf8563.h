...
#define RTCC_STAT1_ADDR			(uint8_t)0x0
#define RTCC_STAT2_ADDR			(uint8_t)0x01
#define RTCC_SEC_ADDR  			(uint8_t)0x02
#define RTCC_MIN_ADDR 			(uint8_t)0x03
#define RTCC_HR_ADDR 			(uint8_t)0x04
#define RTCC_DAY_ADDR 			(uint8_t)0x05
#define RTCC_WEEKDAY_ADDR		(uint8_t)0x06
#define RTCC_MONTH_ADDR 		(uint8_t)0x07
#define RTCC_YEAR_ADDR 			(uint8_t)0x08
#define RTCC_ALRM_MIN_ADDR 	    (uint8_t)0x09
#define RTCC_SQW_ADDR 	        (uint8_t)0x0D
